 ...
 */
static __device__ void ludcmp(UCFDInt block, UCFDReal *A)
{
 ...
 */
static __device__ void lusub(UCFDInt block, UCFDReal *LU, UCFDReal *b)
{
...
static __device__ void lusubmattrans(UCFDInt block, UCFDReal *LU, UCFDReal *B)
{
